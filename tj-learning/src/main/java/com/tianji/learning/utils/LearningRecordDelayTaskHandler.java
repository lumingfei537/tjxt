...
public class LearningRecordDelayTaskHandler {
    ...
    final ThreadPoolExecutor poolExecutor = new ThreadPoolExecutor(16, 20, 60, TimeUnit.SECONDS,new LinkedBlockingQueue<>(10));
    //项目启动后，当前类实例化，属性注入之后 方法就会执行  一般用来做初始化工作
    @PostConstruct
    public void init(){
        log.info("LearningRecordDelayTaskHandler   init()执行了");
